...
Lighting is a computationally intensive phenomena to model. For rendering 
purposes lighting is broken up into shading models, and lighting models. 
Shading models define how the components of light calculations are 


There are two major schools light modeling 
