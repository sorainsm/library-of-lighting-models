...
% To add here - shader calculations are a variability, interpolation is a 
%variability
\begin{itemize}
	\item
\end{itemize}
...
%	expressed in mathematical terms. The IMs are built by refining the TMs 
%	and/or 	GDs.  This section should remain abstract.  The SRS should specify 
%%% the	requirements without considering the implementation.}
...
%	where the derivation cannot be described under the Description field, it 
%	will
